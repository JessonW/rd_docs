 ...
 * 设置地域环境
 *
 * @param regional 地域 默认为北京地区AC.REGIONAL_CHINA；华东地区为AC.REGIONAL_EAST_CHINA；东南亚地区为AC.REGIONAL_SOUTHEAST_ASIA;中欧地区为REGIONAL_NORTH_AMERICA;北美地区为AC.REGIONAL_NORTH_AMERICA
 */
